...
export class MapsClient extends ApiClientBase implements IMapsClient {
    ...
    protected processGet(response: Response): Promise<MapsVm> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = MapsVm.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<MapsVm>(<any>null);
    }
...
export class SeasonsClient extends ApiClientBase implements ISeasonsClient {
    ...
    createWeeks(command: CreateSeasonWeeksCommand): Promise<number> {
        let url_ = this.baseUrl + "/api/Seasons/CreateWeeks";
        url_ = url_.replace(/[?&]$/, "");
...
export class TeamsClient extends ApiClientBase implements ITeamsClient {
    ...
    getTeamSummaryById(teamId: number): Promise<TeamSummaryVm> {
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetTeamSummaryById(_response);
        });
    }

    protected processGetTeamSummaryById(response: Response): Promise<TeamSummaryVm> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    getTeamsBySeasonId(seasonId: number): Promise<TeamsVm> {
        let url_ = this.baseUrl + "/api/Teams/{seasonId}";
        if (seasonId === undefined || seasonId === null)
            throw new Error("The parameter 'seasonId' must be defined.");
        url_ = url_.replace("{seasonId}", encodeURIComponent("" + seasonId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processGetTeamsBySeasonId(_response);
        });
    }

    protected processGetTeamsBySeasonId(response: Response): Promise<TeamsVm> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TeamsVm.fromJS(resultData200);
            return result200;
            });
        } else if (status !== 200 && status !== 204) {
            return response.text().then((_responseText) => {
    ...
    createTeams(command: CreateTeamsCommand): Promise<number> {
        let url_ = this.baseUrl + "/api/Teams/teams";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.transformOptions(options_).then(transformedOptions_ => {
            ...
            return this.processCreateTeams(_response);
        });
    }

    protected processCreateTeams(response: Response): Promise<number> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export class MapsVm implements IMapsVm {
    mapList?: MapsDto[] | undefined;

    constructor(data?: IMapsVm) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["mapList"])) {
                this.mapList = [] as any;
                for (let item of _data["mapList"])
                    this.mapList!.push(MapsDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): MapsVm {
        data = typeof data === 'object' ? data : {};
        let result = new MapsVm();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.mapList)) {
            ...
            for (let item of this.mapList)
                data["mapList"].push(item.toJSON());
        }
        return data; 
    }
}

export interface IMapsVm {
    mapList?: MapsDto[] | undefined;
}

export class MapsDto implements IMapsDto {
    id?: number;
    mapName?: string | undefined;
    mapPack?: string | undefined;
    mapNumber?: number;

    constructor(data?: IMapsDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): MapsDto {
        data = typeof data === 'object' ? data : {};
        let result = new MapsDto();
        result.init(data);
        return result;
    }
...
export class SeasonListVm implements ISeasonListVm {
    seasons?: SeasonStandingsVm[] | undefined;

    constructor(data?: ISeasonListVm) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["seasons"])) {
                ...
                for (let item of _data["seasons"])
                    this.seasons!.push(SeasonStandingsVm.fromJS(item));
            }
        }
    }

    static fromJS(data: any): SeasonListVm {
        data = typeof data === 'object' ? data : {};
        let result = new SeasonListVm();
        result.init(data);
        return result;
    }
...
export interface ISeasonListVm {
    seasons?: SeasonStandingsVm[] | undefined;
}
...
export class TeamsVm implements ITeamsVm {
    teamList?: TeamsDto[] | undefined;

    constructor(data?: ITeamsVm) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["teamList"])) {
                this.teamList = [] as any;
                for (let item of _data["teamList"])
                    this.teamList!.push(TeamsDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): TeamsVm {
        data = typeof data === 'object' ? data : {};
        let result = new TeamsVm();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        if (Array.isArray(this.teamList)) {
            data["teamList"] = [];
            for (let item of this.teamList)
                data["teamList"].push(item.toJSON());
        }
        return data; 
    }
}
...
export class TeamsDto implements ITeamsDto {
    id?: number;
    teamName?: string | undefined;
    ...
    static fromJS(data: any): TeamsDto {
        data = typeof data === 'object' ? data : {};
        let result = new TeamsDto();
        result.init(data);
        return result;
    }
...
export class CreateTeamsCommand implements ICreateTeamsCommand {
    season?: number;
    teamsRequestList?: TeamsRequest[] | undefined;

    constructor(data?: ICreateTeamsCommand) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.season = _data["season"];
            if (Array.isArray(_data["teamsRequestList"])) {
                this.teamsRequestList = [] as any;
                for (let item of _data["teamsRequestList"])
                    this.teamsRequestList!.push(TeamsRequest.fromJS(item));
            }
        }
    }

    static fromJS(data: any): CreateTeamsCommand {
        data = typeof data === 'object' ? data : {};
        let result = new CreateTeamsCommand();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["season"] = this.season;
        if (Array.isArray(this.teamsRequestList)) {
            data["teamsRequestList"] = [];
            for (let item of this.teamsRequestList)
                data["teamsRequestList"].push(item.toJSON());
        }
        return data; 
    }
}

export interface ICreateTeamsCommand {
    season?: number;
    teamsRequestList?: TeamsRequest[] | undefined;
}

export class TeamsRequest implements ITeamsRequest {
    teamName?: string | undefined;
    teamAbbreviation?: string | undefined;
    teamCaptain?: number;

    constructor(data?: ITeamsRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TeamsRequest {
        data = typeof data === 'object' ? data : {};
        let result = new TeamsRequest();
        result.init(data);
        return result;
    }
