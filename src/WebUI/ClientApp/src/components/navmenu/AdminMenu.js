...
function AdminMenu(props) {
    ...
    return (React.createElement(React.Fragment, null, showAdminMenu && (React.createElement(reactstrap_1.UncontrolledDropdown, { nav: true, inNavbar: true },
        ...
        React.createElement(reactstrap_1.DropdownMenu, { right: true },
            ...
            showEditGames && (React.createElement(reactstrap_1.DropdownItem, { divider: true })),
            showEditGames && (React.createElement(reactstrap_1.DropdownItem, { header: true }, "Modify League Data")),
            showAdmin && (React.createElement(reactstrap_1.DropdownItem, null, "Edit Seasons")),
            showAdmin && (React.createElement(reactstrap_1.DropdownItem, null, "Edit Players")),
            showAdmin && (React.createElement(reactstrap_1.DropdownItem, null, "Edit Teams")),
            showEditGames && (React.createElement(reactstrap_1.DropdownItem, null, "Edit Games")))))));
}
