...
var EngineList = function (props) {
    ...
    var handleEngineChange = function (e) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(reactstrap_1.Form, null,
            React.createElement(reactstrap_1.FormGroup, null,
                ...
                React.createElement(reactstrap_1.Input, { type: "select", name: "engine", id: "engineSelect", value: index, onChange: function (e) { return handleEngineChange(e); } }, renderEngineDropdown()))),
